...
var Engine = (function(global) {
    ...
    canvas.width = 505; /* Set up canvas width*/
    canvas.height = 606; /* Set up canvas height*/

    var startScreen = doc.createElement('div');/* Appending start screen*/
    startScreen.id = 'startScreen';
    doc.getElementById('container').appendChild(startScreen);

    var startButton = doc.createElement('button');/* Appending Start button*/
    startButton.id = 'startButton';
    startButton.onclick = kickoff;
    startButton.textContent = 'Start!';
    doc.getElementById('startScreen').appendChild(startButton);

    var scoreInfo = doc.createElement('div');/* Adding score info*/
    scoreInfo.id = 'scoreInfo';
    doc.getElementById('startScreen').appendChild(scoreInfo);

    var mainDiv = document.getElementById('main');/* Appending canvas*/
    ...
    function checkCollisions() { /*Checks for collisions with enemy bugs and updates player position*/
        var colSpace = 25;
        allEnemies.forEach(function(enemy) {
        ...
        canvasCollectibles.forEach(function(canvasCollectible) { /*Updates score when player hits any collecibles*/
            if (canvasCollectible.sprite == "images/Rock.png") {
                ...
                canvasCollectible.remove(); /*removes collectible after player collects it*/
            }
        });
    }
     ...
     */
    function renderEntities() { /*renders all entities like player,enemy bugs and collectibles*/
        allEnemies.forEach(function(enemy) {
            enemy.render();
        });
